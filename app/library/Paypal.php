...
class Paypal{
    ...
    */
    ...
    private function init(){
        ...
        $this->apiLive      = $config->paypal->apiLive;
        $this->apiUsername  = $config->paypal->apiUsername;
        $this->apiPassword  = $config->paypal->apiPassword;
        $this->apiSignature = $config->paypal->apiSignature;

        $url = new Phalcon\Mvc\Url();
        $this->returnUrl    = $config->paypal->returnUrl;
        $this->cancelUrl    = $config->paypal->cancelUrl;
